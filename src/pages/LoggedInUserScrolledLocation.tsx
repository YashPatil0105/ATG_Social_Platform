...
const LoggedInUserScrolledLocation: React.FC<{ userLoggedIn: string }> = ({ userLoggedIn,setUserLoggedIn }) => {
  useEffect(() => {
        ...
        <Row>
          ...
          <Col md={4}>
            <div className="position-relative mb-3">
              ...
              <input type="text" className="form-control location-input" placeholder="Enter your location" />
              <i className="bi bi-x position-absolute" style={{right: '10px', top: '50%', transform: 'translateY(-50%)'}}></i>
            </div>
            <div className="mb-3">
...
export default LoggedInUserScrolledLocation;
